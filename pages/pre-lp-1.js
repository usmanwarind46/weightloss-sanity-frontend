      ...
      <div className="prelander">
        ...
        <main>
          <div className="wrap">
            <div className="grid">
              <div>
                <h1>
                  Your <span className="accent">weight-loss plan</span>, built
                  around you
                </h1>
                ...
                <p className="sub">
                  A UK-regulated clinical assessment and personalised treatment
                  plan, delivered online with transparent pricing from the
                  start.
                </p>
              </div>
              ...
              <div className="card-wrap">
                ...
                <div className="card">
                  <p className="gate">
                    To see available weight loss plans, please confirm
                    you&apos;re over 18
                  </p>
                  ...
                  <p className="microcopy">
                    Subject to online medical assessment
                  </p>
                  <Link className="contact-link" href="/contact-us">
                    Prefer to speak to someone first? Contact our care team
                  </Link>
                </div>
              </div>
            </div>
        ...
        <footer>
          <p className="foot-line">
            © 2026 Online Weight Loss Clinic · GPhC-regulated ·{" "}
        ...
        * {
        ...
        .card-glow {
          ...
          background:
            radial-gradient(
                closest-side,
                rgba(69, 101, 191, 0.28),
                transparent 70%
              )
              15% 20% / 65% 65% no-repeat,
            radial-gradient(
                closest-side,
                rgba(63, 174, 121, 0.24),
                transparent 70%
              )
              85% 80% / 65% 65% no-repeat;
          filter: blur(28px);
        }
        .card {
        ...
        .prelander :global(.cta-btn):hover {
          transform: translateY(-1px);
          box-shadow: 0 14px 28px -12px rgba(0, 0, 0, 0.4);
        }
        .prelander :global(.cta-btn):focus-visible {
          outline: 3px solid var(--focus-ring);
          outline-offset: 3px;
        }
        .prelander :global(.cta-btn) svg {
          width: 16px;
          height: 16px;
          flex: none;
        }
