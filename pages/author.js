...
const AuthorDetails = ({ seoSettings, siteSettings }) => {
  const autoSchemas = generateSchema({
    globalSeo: seoSettings,
    canonical: `${meta_url}/author/`,
  });
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-white order-2 md:order-1">
            ...
            <h2 className="text-3xl md:text-5xl font-semibold mb-3">
              Roj Helin Parlakyildiz, MPharm
            </h2>

            {/* <p className="inline-block bg-[#E0EDFF] text-[#0f3f2f] text-sm rounded-md px-3 py-1 mb-4">
              GMC No.{" "}
              <a
